      ...
      <div className="main-page-inner">
        ...
        <div className="main-page-content">
          ...
          <p className="main-page-content-info">
            Front end developer with over 5 years of industry experience in
            application design, development. Skilled in React, Redux, React
            Hook,Jquery, css3, Sass, Html5 and Test Driven Development.
          </p>
        </div>
      </div>
      <div className="main-page-social">
        <a href="https://twitter.com/jsgeekes" title='Twitter Account' className="twitter">
          <svg
        ...
        <a href="https://linkedin.com/in/jsgeek" title='Linkedin Account'  className="linkedin">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
